...
4. Create and push a release tag such as `v1.8.2`.
...
For `1.8.2`, inspect the packages before publishing:
...
```xml
<PackageReference Include="AstraFlow.Mediator" Version="1.8.2" />
<PackageReference Include="AstraFlow.Mapper" Version="1.8.2" />
<PackageReference Include="AstraFlow.Mapper.Conventions" Version="1.8.2" />
<PackageReference Include="AstraFlow.Mapper.EntityFrameworkCore" Version="1.8.2" />
<PackageReference Include="AstraFlow.Diagnostics" Version="1.8.2" />
```

Use `AstraFlow.Contracts` in shared contract projects that should not reference the mediator runtime:

```xml
<PackageReference Include="AstraFlow.Contracts" Version="1.8.2" />
```

Use `AstraFlow.Testing` only in test projects:

```xml
<PackageReference Include="AstraFlow.Testing" Version="1.8.2" />
```
...
```xml
<PackageReference Include="AstraFlow" Version="1.8.2" />
```
