...
4. Create and push a release tag such as `v1.8.4`.
...
For `1.8.4`, inspect the packages before publishing:
...
```xml
<PackageReference Include="AstraFlow.Mediator" Version="1.8.4" />
<PackageReference Include="AstraFlow.Mapper" Version="1.8.4" />
<PackageReference Include="AstraFlow.Mapper.Conventions" Version="1.8.4" />
<PackageReference Include="AstraFlow.Mapper.EntityFrameworkCore" Version="1.8.4" />
<PackageReference Include="AstraFlow.Diagnostics" Version="1.8.4" />
```

Use `AstraFlow.Contracts` in shared contract projects that should not reference the mediator runtime:

```xml
<PackageReference Include="AstraFlow.Contracts" Version="1.8.4" />
```

Use `AstraFlow.Testing` only in test projects:

```xml
<PackageReference Include="AstraFlow.Testing" Version="1.8.4" />
```

Use `AstraFlow.Analyzers` as a private analyzer reference:

```xml
<PackageReference Include="AstraFlow.Analyzers" Version="1.8.4" PrivateAssets="all" />
```
...
```xml
<PackageReference Include="AstraFlow" Version="1.8.4" />
```
