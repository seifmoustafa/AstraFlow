...
Starting in `1.2.2`, the core packages support `netstandard2.0`, `net8.0`, `net9.0`, and `net10.0`. The optional EF Core projection validation package remains `net10.0` because it follows EF Core 10.
