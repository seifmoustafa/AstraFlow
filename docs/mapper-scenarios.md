...
Supported destination shapes in `1.7.0`:
...
- AstraFlow `1.7.0` validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
