...
Supported destination shapes in `1.8.3`:
...
- AstraFlow `1.8.3` validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
