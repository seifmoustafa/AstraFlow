...
Supported destination shapes in v1.2.2:
...
- AstraFlow v1.2.2 validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
