...
Supported destination shapes in v1.2.1:
...
- AstraFlow v1.2.1 validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
