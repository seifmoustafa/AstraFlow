...
Supported destination shapes in `1.8.2`:
...
- AstraFlow `1.8.2` validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
