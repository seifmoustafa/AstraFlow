...
Supported destination shapes in v1.4.0:
...
- AstraFlow v1.4.0 validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
