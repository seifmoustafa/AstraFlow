...
Supported destination shapes in `1.7.1`:
...
- AstraFlow `1.7.1` validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
