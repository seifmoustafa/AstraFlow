...
Supported destination shapes in `1.10.0`:
...
- AstraFlow `1.10.0` validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
