...
Supported destination shapes in v1.3.0:
...
- AstraFlow v1.3.0 validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
