...
Supported destination shapes in v1.2.3:
...
- AstraFlow v1.2.3 validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
