...
Supported destination shapes in `1.8.4`:
...
- AstraFlow `1.8.4` validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
