...
Supported destination shapes in `1.11.0`:
...
- AstraFlow `1.11.0` validates projection registrations and high-risk expression patterns through `IProjectionValidator`.
