...
try {
    ...
    Invoke-DotNetStep "Pack AstraFlow.Security" @("pack", ".\src\AstraFlow.Security\AstraFlow.Security.csproj", "-c", $Configuration, "--no-build", "--no-restore", "/m:1", "/p:UseSharedCompilation=false")
